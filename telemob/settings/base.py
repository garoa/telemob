...
SECRET_KEY = '(srb(-(%2)h4eo$+mdrpxtpdtejb4q!-zzu7oj#-x*22v97(t&'
...
# See: https://docs.djangoproject.com/en/dev/ref/settings/#session-serializer
# SESSION_SERIALIZER = None
########## END CUSTOM SESSION CONFIGURATION
