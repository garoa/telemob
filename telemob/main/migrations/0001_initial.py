    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'name',
                    models.CharField(max_length=150, verbose_name='Nome da Campanha'),
                ),
                ...
                (
                    'last_updated',
                    models.DateField(
                        auto_now=True, verbose_name='Última atualização em'
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'parliamentary_name',
                    models.CharField(max_length=150, verbose_name='Nome Parlamentar'),
                ),
                (
                    'political_party',
                    models.CharField(
                ...
                (
                    'category',
                    models.CharField(
                        choices=[('T', 'Titular'), ('S', 'Suplente'), ('E', 'Efetivo')],
                        max_length=20,
                ...
                (
                    'annex',
                    models.IntegerField(blank=True, null=True, verbose_name='Anexo'),
                ),
                (
                    'chamber',
                    models.IntegerField(blank=True, null=True, verbose_name='Gabinete'),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'name',
                    models.CharField(max_length=150, verbose_name='Nome da Ajuda'),
                ),
                        ...
                        choices=[
                            ...
                            (
                                ...
                                (
                                    (
                                        '20',
                                        'Nada a reportar: correio vai entregar no gabinete!',
                                    ),
                                ),
                            ),
                            (
                            ...
                            (
                                ...
                                (
                                    (
                                        '40',
                                        'E-mail enviado e não voltou, tomara que leiam.',
                                    ),
