...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.result'
        db.alter_column(u'main_contact', 'result', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Contact.result'
        db.alter_column(u'main_contact', 'result', self.gf('django.db.models.fields.CharField')(default=None, max_length=10))
    ...
    models = {
        ...
        u'main.contact': {
            ...
            'result': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
        u'main.helptext': {
